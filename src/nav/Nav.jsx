...
export const Nav = () => {
  ...
  return (
    <>
    <nav
    className="relative flex w-full flex-wrap items-center justify-between bg-blue-900 py-3 text-neutral-200 shadow-lg lg:flex-wrap lg:justify-start"
    data-te-navbar-ref>
    <div className="flex w-full flex-wrap items-center justify-between px-6 ">
      ...
      <div
        ...
        <a className="pr-2 text-xl font-semibold text-white" href="/">TMDB</a>
        {/* <!-- Left links --> */}
        <ul
